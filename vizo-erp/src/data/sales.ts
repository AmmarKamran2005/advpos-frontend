...
export const orders: Order[] = [
  ...
  /* Over their credit limit — blocked until the owner decides */
  o(16, "ORD-26-0143", 2,  "Mobile Zone Lahore",       "MZ", "Retailer",    "Lahore",    "Order Department", "LOC-02", "Imran Iqbal", "2026-08-14", "CREDIT_HOLD", 96000,  "CREDIT",    "UNPAID",  "cargo", "Rehman Cargo",           "—",           null,         null,         "NOT_DISPATCHED", null,     "Already PKR 84,500 out; this pushes the balance PKR 30,500 over limit", 0),
  o(17, "ORD-26-0144", 9,  "Mobile Mart Multan",       "MM", "Retailer",    "Multan",    "Order Department", "LOC-02", "Zara Malik",  "2026-08-14", "CREDIT_HOLD", 52000,  "CREDIT",    "UNPAID",  "cargo", "Pak International Cargo","—",           null,         null,         "NOT_DISPATCHED", null,     "Two invoices 45+ days overdue; limit crossed by PKR 18,000", 0),
