 ...
 * the order department sees a work queue; accounts sees collections waiting on
 * confirmation; the owner sees the business at a glance and the decisions that
 * are genuinely his. Every role now has its own home, so the generic children
